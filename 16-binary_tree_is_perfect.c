...
/**
 * depth - This function returns the depth of a give
...
/**
 * get_leaf - This funcion eturns a leaf of a binary tree
 ...
 *
 * Return: If the tree is perfect,return 1 else 0
 */
int is_perfect_recursive(const binary_tree_t *tree,
		size_t leaf_depth, size_t level)
{
 ...
 * Return: If tree is NULL or not perfect,return 1 else 0
 */
int binary_tree_is_perfect(const binary_tree_t *tree)
{
	if (tree == NULL)
